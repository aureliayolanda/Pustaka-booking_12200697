...
class PenggunaController extends BaseController
{
    public function index()
    {
        return view('halaman/pengguna/table', [
            'xx'    => (new Pengguna12200697())->get()->getResult(),
    ...
    public function simpan()
    {
        ...
        if ($this->validasi()) {
            $r = (new Pengguna12200697())->insert($data);
    ...
    {
        $data = (new Pengguna12200697())->where('id', $id)->first();
    ...
    public function patch()
    {
        ...
        if ($this->validasiPatch()) {
            $r = (new Pengguna12200697())->update($id, $data);
            if ($r == true) {
                return redirect()->to('/pengguna-list');
            } else {
    ...
    {
        $id = $this->request->getPost('id');
        $r = (new Pengguna12200697())->delete($id);
